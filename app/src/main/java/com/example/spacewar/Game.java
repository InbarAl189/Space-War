...
public class Game {
    ...
    private int m_CurrLevel, m_EnemiesCounter, m_enemyKingLives = 70;



    // Objects
    Player m_Player;
    ValueEnemyItem m_Enemy_one, m_Enemy_two, m_Enemy_three, m_Enemy_four, m_Enemy_five, m_Enemy_six, m_Enemy_king, m_Gift;
    GameItem m_KingShotOne, m_KingShotTwo, m_KingShotThree, m_Shot;
    NonValueEnemyItem m_Asteroid_one, m_Asteroid_two, m_Asteroid_three;
